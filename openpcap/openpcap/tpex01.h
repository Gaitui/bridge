...
TPEX01 decodeTPEX01(int h,u_char *pkt_data,Head head)
{
    TPEX01 temp;
    temp.head = head;
    h+=10;
...
void printTPEX01(FILE *fptr,TPEX01 tw,std::vector<int> address,int port)
{
    char outbuffer[500]="";
    char tempbuffer[50];
